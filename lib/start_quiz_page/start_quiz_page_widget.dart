...
class StartQuizPageWidget extends StatefulWidget {
  const StartQuizPageWidget({
    Key? key,
    this.testName,
    this.testDurationHour,
    this.testDurationMin,
    this.section,
    this.totalQue,
    this.testId,
    this.studentId,
  ...
  final String? testDurationHour;
  final String? testDurationMin;
  ...
  @override
  _StartQuizPageWidgetState createState() => _StartQuizPageWidgetState();
}
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                'Review your test below and click on the Start Test button to proceed.',
                                style: FlutterFlowTheme.of(context)
                                    .bodyText2
                                    .override(
                                      fontFamily: 'Outfit',
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  functions.str2str(widget.testDurationHour!,
                                      widget.testDurationMin!),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyText1
                                      .override(
                                        fontFamily: FlutterFlowTheme.of(context)
                          ...
                          Padding(
                            padding:
                                EdgeInsetsDirectional.fromSTEB(16, 30, 16, 24),
