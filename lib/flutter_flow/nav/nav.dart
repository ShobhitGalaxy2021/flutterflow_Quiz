...
class AppStateNotifier extends ChangeNotifier {
  QuizAppFirebaseUser? initialUser;
  QuizAppFirebaseUser? user;
  ...
  void update(QuizAppFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'MyReportPage',
              path: 'myReportPage',
              builder: (context, params) => MyReportPageWidget(),
            ),
            FFRoute(
              name: 'SignIn',
              path: 'signIn',
            ...
            FFRoute(
              name: 'StartQuizPage',
              path: 'startQuizPage',
              builder: (context, params) => StartQuizPageWidget(
                testName: params.getParam('testName', ParamType.String),
                testDurationHour:
                    params.getParam('testDurationHour', ParamType.String),
                testDurationMin:
                    params.getParam('testDurationMin', ParamType.String),
                section: params.getParam('section', ParamType.String),
                totalQue: params.getParam('totalQue', ParamType.String),
            ...
            FFRoute(
              ...
              path: 'testForFixColumn',
              builder: (context, params) => TestForFixColumnWidget(),
            ),
            FFRoute(
              name: 'MainQuizPageCopy',
              path: 'mainQuizPageCopy',
              builder: (context, params) => MainQuizPageCopyWidget(),
            )
