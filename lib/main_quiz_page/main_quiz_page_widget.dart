...
class MainQuizPageWidget extends StatefulWidget {
  const MainQuizPageWidget({Key? key}) : super(key: key);

  @override
  _MainQuizPageWidgetState createState() => _MainQuizPageWidgetState();
}

class _MainQuizPageWidgetState extends State<MainQuizPageWidget> {
                                  ...
                                  Padding(
                                    ...
                                    child: FlutterFlowRadioButton(
                                      ...
                                      onChanged: (val) async {
                                        ...
                                        apiResultc4c =
                                            await SaveQuestionResponseCall.call(
                                          accessToken: FFAppState().accessToken,
                                                  ...
                                                  builder:
                                                    ...
                                                    return AlertDialog(
                                                      title:
                                                          Text('Skip Question'),
                                                      content: Text(
                                                          'Are you sure you want to skip because you won\'t be able to come previous'),
                                                      actions: [
                                                        TextButton(
                                                          onPressed: () =>
                                                              Navigator.pop(
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          onTap: () async {
                                            if (FFAppState().isAnswerSelected ==
                                                '0') {
                                              setState(() {
